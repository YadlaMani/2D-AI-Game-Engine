...
class Agent:
    ...
    def get_state(self, game:SpaceShooter):
            ...
            state = [
                ...
                # game.asteroids[3].x < game.player.x if (len(game.asteroids) > 3) else 0,  # Asteroid left
                # game.asteroids[3].x > game.player.x+game.player.width if (len(game.asteroids) > 3) else 0,  # Asteroid right
                # game.asteroids[3].y < game.player.y+game.player.height if (len(game.asteroids) > 3) else 0,  # Asteroid up
