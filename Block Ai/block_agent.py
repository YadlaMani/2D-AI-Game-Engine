...
class Agent:
    ...
    def get_state(self, game:MarioRunner):
            ...
            # state = [
            #     1 if len(game.obstacles)>0 and game.obstacles[0].x == (game.player.x + game.player.rect.width) and ( game.obstacles[0].y ==  (HEIGHT - GROUND_HEIGHT - OBSTACLE_HEIGHT)) else 0,
            #     1 if len(game.obstacles)>0 and game.obstacles[0].x == (game.player.x + game.player.rect.width) and (game.obstacles[0].y ==  (HEIGHT-GROUND_HEIGHT-OBSTACLE_HEIGHT-(PLAYER_HEIGHT*0.75))) else 0,
            #     game.player.jump,
            #     game.player.crouch,
            #     ]
